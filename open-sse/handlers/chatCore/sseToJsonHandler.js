 ...
 */
export async function handleForcedSSEToJson({ providerResponse, sourceFormat, provider, model, body, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, clientIp, clientRawRequest, onRequestSuccess, trackDone, appendLog, reqTag, log }) {
