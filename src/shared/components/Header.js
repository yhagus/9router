...
import { OAUTH_PROVIDERS, APIKEY_PROVIDERS, APP_NAME } from "@/shared/constants/config";
...
const getPageInfo = (pathname) => {
  ...
  if (pathname.includes("/mitm"))
    return {
      title: "MITM Proxy",
      description: `Intercept CLI tool traffic and route through ${APP_NAME}`,
      icon: "security",
      breadcrumbs: [],
    };
  ...
  if (pathname.includes("/skills"))
    return {
      title: "Agent Skills",
      description: `Copy a link and paste to your AI to use ${APP_NAME} — no install needed`,
      icon: "extension",
      breadcrumbs: [],
    };
