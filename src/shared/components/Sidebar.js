...
import { APP_CONFIG, APP_NAME, UPDATER_CONFIG } from "@/shared/constants/config";
...
const navItems = [
  ...
  { href: "/dashboard/free-tracker", label: "Free Tracker", icon: "loyalty" },
...
const integrationsItems = [
  { href: "/dashboard/tools", label: "Tools", icon: "construction" },
];
  ...
  return (
    <div className="w-full max-w-lg rounded-xl bg-neutral-900/95 border border-white/10 p-6 text-white">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h2 className="text-lg font-semibold">Update {APP_NAME}{latestVersion ? ` to v${latestVersion}` : ""}</h2>
